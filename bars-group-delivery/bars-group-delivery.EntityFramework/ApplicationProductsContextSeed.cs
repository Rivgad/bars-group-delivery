    ...
    public class ApplicationProductsContextSeed
    {
            ...
            int retry = 0)
        {
            ...
            try
            {
                ...
                if (!await dbContext.Ingredients.AnyAsync())
                {
                    await dbContext.Ingredients.AddRangeAsync(
                        GetPreconfiguredIngredients());
        ...
        public static IEnumerable<Product> GetPreconfiguredProducts()
        {
            ...
            {
                new Product(){ Id=1, CategoryId=1, Title="Бургер делюкс", Price=800, Fats=30, Carbs=50, Proteins=20, Kcal=600, Weight=450 },
                new Product(){ Id=2, CategoryId=2, Title="ТОФУ РОЛЛ", Price=400, Fats=19, Carbs=88, Proteins=10, Kcal=330, Weight=450 },
                new Product(){ Id=1, CategoryId=3, Title="Классический ролл с огурцом", Price=130, Fats=30, Carbs=50, Proteins=20, Kcal=123.8f, Weight=450 },
                new Product(){ Id=1, CategoryId=4, Title="Классический ролл с дайконом", Price=129, Fats=1.1f, Carbs=37.6f, Proteins=3.7f, Kcal=151.6f, Weight=450 },
            };
        }
    }
}
